...
\lhead{Capítulo 3. \emph{Syntax and Semantics}}
...
Since we are not using the Isabelle's predefined \verb|int| type, in order to work with words and to support code generation for them we use the Native Word entry in the Archive of Formal Proofs\cite{Native_Word-AFP}.
...
This memory model is inspired in the work of Blazy and Leroy\cite{leroy-blazy-memory-model}, it is a simpler model adjusted to satisfy our needs.
