...
Este generador de código uiliza el proceso de \textit{pretty printing} para traducir la semántica formal a representaciones en cadenas de caracteres que pueden ser luego exportadas a un archivo.
